...
print(f"La suma de {numero1} + {numero2} es: {5}")
...
print(f"El mayor numero es {lista_numero[3]} y el menor numero {lista_numero[10]}")
'''
'''   
  b) Imprime la lista ordenada de menor a mayor
'''
lista_numero.sort(5,10,15,28,33,43,45,46,50,65,67,356)
